    ...
    <style>
      ...
      @media (min-width: 992px) {
        ...
        .header-3-3 .navbar-light .navbar-nav .active:before {
          ...
          width: 80%;
          /* or 100px */
          border-bottom: 2px solid #E465A6;
        }
        ...
        <div class="mx-auto d-flex flex-lg-row flex-column hero">
          ...
          <div
            ...
            <h1 class="title-text-big">
              ...
              <span style="color: #E465A6">IpongQ</span>?<br class="d-lg-block d-none" />

            </h1>
            <p class="text-caption">
              IpongQ adalah sebuah layanan penyewaan iPhone yang menghadirkan teknologi terkini dari Apple kepada
              seluruh lapisan masyarakat Indonesia.
              <br class="d-sm-block d-none" />
              Kami memahami bahwa memiliki iPhone dengan teknologi terbaru dapat menjadi beban finansial, oleh karena
              itu, IpongQ hadir untuk memberikan solusi yang lebih terjangkau dan fleksibel.
            </p>
          ...
          <div class="right-column d-flex justify-content-center justify-content-lg-start text-center pe-0">
            <img class="position-absolute d-lg-block d-none hero-right" style="width: 450px"
              src="assets/img/logoTerbaru.png" alt="logo" />
