                        ...
                        while ($data = mysqli_fetch_array($query)) { ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    $message = $data['kritik'];
                                    $key = "12345678901234567890123456789012"; // Kunci rahasia untuk dekripsi
                                
                                    $decrypt1 = xor_encrypt($message, $key); // Dekripsi data menggunakan XOR dengan kunci yang sama
                                    $final = dekripsi_rot13($decrypt1); // Balikkan enkripsi Rot13
                                    echo $final;
                                    ?>
                                </td>
                            </tr>
